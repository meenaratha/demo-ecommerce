@extends('website.layouts.page-app')
@section('content')
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <img src="{{ asset('website//catalog/demo/product/electronic/25.jpg')}}" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <img src="{{ asset('website//catalog/demo/product/electronic/19.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <img src="{{ asset('website//catalog/demo/product/travel/8.jpg')}}" alt="Philipin Tour Group Manila/ Pattaya / Mactan ">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <img src="{{ asset('website//catalog/demo/product/electronic/4.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <a class="lt-image" data-product="104" href="#" target="_self" title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                <img src="{{ asset('website//catalog/demo/product/electronic/15.jpg')}}" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <a class="lt-image" data-product="66" href="#" title="Compact Portable Charger (Power Bank) with Premium">
                <img src="{{ asset('website//catalog/demo/product/electronic/14.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <a class="lt-image" target="_self" title="Philipin Tour Group Manila/ Pattaya / Mactan ">
                <img src="{{ asset('website//catalog/demo/product/travel/4.jpg')}}" alt="Philipin Tour Group Manila/ Pattaya / Mactan ">
                </a>
               </div>
            </div>
           </div>
           ...
           <div class="media-left">
            <div class="item-image">
               <div class="item-img-info product-image-container ">
                ...
                <a class="lt-image" data-product="78" href="#">
                <img src="{{ asset('website//catalog/demo/product/electronic/6.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                </a>
               </div>
            </div>
           </div>
...
<div class="static-image-home-left banners">
   <div><a title="Static Image" href="#"><img src="{{ asset('website/image/catalog/demo/banners/image-left.jpg')}}" alt="Static Image"></a></div>
</div>
</div>
</aside>
...
<div class="product-view-inner clearfix">
    ...
    <div class="large-image  class-honizol">
     <div class="box-label">
      <span class="label-product label-sale">
        {{ $relatedProduct->discount_option }}%
      </span>
     </div>
     <img class="product-image-zoom" src="{{ asset($relatedProduct->productimage) }}" data-zoom-image="{{ asset($relatedProduct->productimage) }}" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
    </div>
   ...
   <div class="content-product-right col-md-7 col-sm-6 col-xs-12">
    ...
    <div class="title-product">
     <h1>{{ $relatedProduct->product_name }}</h1>
    </div>
    ...
    <div class="product_page_price price" itemscope="" itemtype="http://data-vocabulary.org/Offer">
     <span class="price-new"><span id="price-special">${{ $relatedProduct->discount_price }}</span></span>
     <span class="price-old" id="price-old">${{ $relatedProduct->original_price }}</span>
     <div class="price-tax"><span>Ex Tax:</span> ${{ $relatedProduct->tax }}</div>
    </div>
    <div class="product-box-desc">
     <div class="inner-box-desc">
      <div class="brand"><span>Brand: </span><a href="#">{{ $relatedProduct->brand }}</a></div>
      <div class="model"><span>Product Code: </span>{{ $relatedProduct->product_code }}</div>
      <div class="reward"><span>Reward Points:</span> {{ $relatedProduct->reward_point }}</div>
      <div class="stock"><span>Availability:</span> <i class="fa fa-check-square-o"></i>{{ $relatedProduct->stock }}</div>
     </div>
    </div>
        ...
        <div class="category-slider-inner products-list yt-content-slider releate-products grid" data-rtl="no" data-autoplay="no" data-pagination="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column0="3" data-items_column1="3" data-items_column2="2" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
            ...
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset($relatedProduct->productimage) }} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
              ...
              <div class="right-block">
                <div class="caption">
                  <h4><a href="{{ route('related-products.show', ['id' => $relatedProduct->id]) }}">{{ $relatedProduct->product_name }}</a></h4>
                  <div class="total-price clearfix" style="visibility: hidden; display: block;">
                    <div class="price price-left">
                      <span class="price-new">${{ $relatedProduct->discount_price }}</span>
                      <span class="price-old">${{ $relatedProduct->original_price }}</span>
                    </div>
                  ...
                  <div class="description hidden">
                    <p>T{{ $relatedProduct->product_description }}</p>
                  </div>
                </div>
                <div class="button-group">
                  <div class="button-inner so-quickview">
                    <a class="quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="" data-fancybox-type="iframe" href="{{ route('quick-view', ['id' =>$relatedProduct->id]) }}" data-original-title="Quickview "> <i class="fa fa-search"></i> </a>
          ...
          {{-- <div class="product-layout">
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset('website/image/catalog/demo/product/electronic/6.jpg')}} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
              ...
              <div class="right-block">
                ...
                <div class="button-group">
                  <div class="button-inner so-quickview">
                    <a class="quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="" data-fancybox-type="iframe" href="{{ url('/quick-view') }}" data-original-title="Quickview "> <i class="fa fa-search"></i> </a>
                    <button class="wishlist btn-button" type="button" data-toggle="tooltip" title="" onclick="wishlist.add('78');" data-original-title="Add to Wish List"><i class="fa fa-heart-o"></i></button>
                    <button class="compare btn-button" type="button" data-toggle="tooltip" title="" onclick="compare.add('78');" data-original-title="Compare this Product"><i class="fa fa-retweet"></i></button>
                    <button class="addToCart btn-button" type="button" data-toggle="tooltip" title="" onclick="cart.add('78', '2');" data-original-title="Add to Cart"><span class="hidden">Add to Cart </span></button>
                  </div>
          ...
          <div class="product-layout">
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset('website/image/catalog/demo/product/electronic/8.jpg')}} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
          ...
          <div class="product-layout">
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset('website/image/catalog/demo/product/electronic/28.jpg')}} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
          ...
          <div class="product-layout">
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset('website/image/catalog/demo/product/electronic/4.jpg')}} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
              ...
              <div class="right-block">
                ...
                <div class="button-group">
                  <div class="button-inner so-quickview">
                    <a class="quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="" data-fancybox-type="iframe" href="{{ url('/quick-vew') }}" data-original-title="Quickview "> <i class="fa fa-search"></i> </a>
                    <button class="wishlist btn-button" type="button" data-toggle="tooltip" title="" onclick="wishlist.add('78');" data-original-title="Add to Wish List"><i class="fa fa-heart-o"></i></button>
                    <button class="compare btn-button" type="button" data-toggle="tooltip" title="" onclick="compare.add('78');" data-original-title="Compare this Product"><i class="fa fa-retweet"></i></button>
                    <button class="addToCart btn-button" type="button" data-toggle="tooltip" title="" onclick="cart.add('78', '2');" data-original-title="Add to Cart"><span class="hidden">Add to Cart </span></button>
                  </div>
          ...
          <div class="product-layout">
            <div class="product-item-container">
              <div class="left-block">
                <div class="product-image-container">
                  <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                    <img src="{{ asset('website/image/catalog/demo/product/electronic/11.jpg')}} " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                  </a>
                </div>
              </div>
              <div class="box-label">
