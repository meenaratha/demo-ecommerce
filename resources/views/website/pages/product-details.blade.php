...
<div class="mod-content box-category">
   <ul class="accordion" id="accordion-category">
    ...
    <li class="panel">
     ...
     <span class="head"><a class="pull-right accordion-toggle " data-toggle="collapse" data-parent="#accordion-category" href="#category{{ $category->id }} "></a></span>
     <div id="category{{ $category->id }}" class="panel-collapse collapse  " style="clear:both">
      <ul>
         <li>
          <a href="#">{{ $category->sub_category }} </a>
         </li>
   ...
   <div class="content-product-right col-md-7 col-sm-6 col-xs-12">
    ...
    <div class="product-box-desc">
     <div class="inner-box-desc">
      ...
      <div class="reward"><span>Reward Points:</span> {{ $product->reward_point }}</div>
      <div class="stock"><span>Availability:</span> <i class="fa fa-check-square-o"></i>{{ $product->stock }}</div>
     </div>
    </div>
              ...
              <div class="right-block">
                ...
                <div class="button-group">
                  <div class="button-inner so-quickview">
                    <a class="quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="" data-fancybox-type="iframe" href="{{ route('quick-view', ['id' => $product->id]) }}" data-original-title="Quickview "> <i class="fa fa-search"></i> </a>
