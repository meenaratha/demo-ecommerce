        ...
        <div class="container page-builder-ltr">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col_k2sd col-style">
                    <div class="module sohomepage-slider so-homeslider-ltr">
                      ...
                      <div class="item">
                       ...
                       <img class="responsive" src="{{asset('website/image/catalog/demo/slider/home6/slider-31.jpg')}}" alt="slide 6 - 1">
                       </a>
                    ...
                    <div class="item">
                       ...
                       <img class="responsive" src="{{asset('website/image/catalog/demo/slider/home6/slider-32.jpg')}}" alt="slide 6 - 2">
                       </a>
                       <div class="sohomeslider-description">
                       </div>
                    </div>
                    <div class="item">
                       ...
                       <img class="responsive" src="{{asset('website/image/catalog/demo/slider/home6/slider-33.jpg')}}" alt="slide 6 - 3">
                       </a>
                       <div class="sohomeslider-description">
                       </div>
                    </div>
                    <div class="item">
                       ...
                       <img class="responsive" src="{{asset('website/image/catalog/demo/slider/home6/slider-34.jpg')}}" alt="slide 6 - 4">
                       </a>
                       <div class="sohomeslider-description">
                       </div>
                    </div>
                          ...
                          <div class="banner-layout-2 h6-banner-1 clearfix">
                              <div class="banner-1 banners">
                                  <div>
                                      ...
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_1.jpg')}}" alt="Static ">
                                      </a>
                                  </div>
                              </div>
                              <div class="banner-2 banners">
                                  <div>
                                      <a href="#" title="Banner 2">
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_2.jpg')}}" alt="Static ">
                                      </a>
                                  </div>
                              ...
                              <div class="banner-3 banners">
                                  <div>
                                      <a href="#" title="Banner 2">
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_4.jpg')}}" alt="Static">
                                      </a>
                                  </div>
                              </div>
                              <div class="banner-4 banners">
                                  <div>
                                      <a href="#" title="Banner 2">
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_3.jpg')}}" alt="Static ">
                                      </a>
                                  </div>
                              ...
                              <div class="banner-5 banners">
                                  <div>
                                      <a href="#" title="Banner 2">
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_6.jpg')}}" alt="Static">
                                      </a>
                                  </div>
                              </div>
                              <div class="banner-6 banners">
                                  <div>
                                      <a href="#" title="Banner 2">
                                      <img src="{{asset('website/image/catalog/demo/banners/home6/home6_5.jpg')}}" alt="Static Image">
                                      </a>
                                  </div>
                              </div>
                          </div>
            ...
            <div class="cate-html">
              <ul class="cate-html-item contentslider" data-rtl="no" data-loop="no" data-autoplay="yes" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="27" data-items_column0="6" data-items_column1="4" data-items_column2="3" data-items_column3="3" data-items_column4="2" data-arrows="yes" data-pagination="no" data-lazyload="no" data-hoverpause="yes">
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-1.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  <h4><a href="#">Food & Restaurant</a></h4>
                  </div>
                </li>
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-2.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  <h4><a href="#">SPA & Massage</a></h4>
                  </div>
                </li>
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-3.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  <h4><a href="#">Health Care</a></h4>
                  </div>
                </li>
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-4.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  <h4><a href="#">Fashion</a></h4>
                  </div>
                </li>
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-5.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  <h4><a href="#">Health Care</a></h4>
                  </div>
                </li>
                <li class="item">
                  <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('website/image/catalog/demo/banners/home3/cate-6.jpg')}}" alt="Static Image"></a></div>
                  <div class="item-content">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_1x14">
                                      <div class="qr-code-block block">
                                          <div class="item-image">
                                              <img src="{{asset('website/image/catalog/demo/banners/home6/qr.png')}}" alt="" width="65" height="65">
                                          </div>
                                          <div class="item-content">
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/5-60x60.png')}}" alt="Pariatur beef desktop publishing packages monst">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/15-60x60.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/21-60x60.png')}}" alt="Maciti Aliqua occur that pleasures have a lotem">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    <a class="lt-image"
                                      href="product.html" target="_blank"
                                      title="Est Officia Including Shoes Beautiful Pi..">
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/24-60x60.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/14-60x60.png')}}" alt="Ligula tortoram ut labore et dolore magna elip">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/fashion/10-60x60.jpg')}}" alt="Amazing Yoga Sport Poses Most  People Wouldn't Dream ">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                  ...
                  <div class="banner-layout-3 bt-1 clearfix banners">
                    <div class="">
                      <a class="bn-shadow" href="#" title="Banner 1">
                        <img src="{{asset('website/image/catalog/demo/banners/home6/01.jpg')}}" alt="Static Image">
                      </a>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/25-210x210.jpg')}}" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                    </a>
                                  </div>
                                  <div class="box-label">
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/19-210x210.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                                    </a>
                                  </div>
                                  <div class="box-label">
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/4-210x210.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                                    </a>
                                  </div>
                                  <div class="box-label">
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/1-210x210.png')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                    </a>
                                  </div>
                                  <div class="box-label">
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/11-210x210.jpg')}}" alt="Charger  Compact Portable with Premium">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                    <span class="label-product label-sale">-20% </span>
                              ...
                              <div class="product-item-container">
                                <div class="left-block ">
                                  <div class="product-image-container so-quickview">
                                    ...
                                    <img src="{{asset('website/image/catalog/demo/product/electronic/13-210x210.jpg')}}" alt="Compact Portable Charger (External Battery)">
                                    </a>
                                  </div>
                                  <div class="box-label">
                                  </div>
                  ...
                  <div class="block-testimonial bn-shadow">
                    <div class="testimonial-items contentslider" data-rtl="no" data-loop="no" data-autoplay="yes" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="1" data-items_column1="1" data-items_column2="1" data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-hoverpause="yes">
                      <div class="item">
                        ...
                        <div class="img"><img src="{{asset('website/image/catalog/demo/banners/home3/user-2.jpg')}}" alt="Static Image"></div>
                      ...
                      <div class="item">
                        ...
                        <div class="img"><img src="{{asset('website/image/catalog/demo/banners/home3/user-1.jpg')}}" alt="Static Image"></div>
                      ...
                      <div class="item">
                        ...
                        <div class="img"><img src="{{asset('website/image/catalog/demo/banners/home3/user-3.jpg')}}" alt="Static Image"></div>
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <img src="{{asset('website/image/catalog/demo/product/electronic/1-226x226.jpg')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <a class="lt-image" href="product.html" target="_self">
                                      <img src="{{asset('website/image/catalog/demo/product/electronic/11-226x226.jpg')}}" alt="Charger  Compact Portable with Premium" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <a class="lt-image" href="product.html" target="_self">
                                      <img src="{{ asset('website/image/catalog/demo/product/electronic/26-226x226.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <a class="lt-image" href="product.html" target="_self">
                                      <img src="{{ asset('website/image/catalog/demo/product/electronic/6-226x226.jpg')}}" alt="Mammo Diablo except to obtain some advan from" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <a class="lt-image" href="product.html" target="_self">
                                      <img src="{{asset('website/image/catalog/demo/product/electronic/29-226x226.jpg')}}" alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                                ...
                                <div class="left-block ">
                                  <div class="product-image-container">
                                    <div class="image so-quickview">
                                      ...
                                      <a class="lt-image" href="product.html" target="_self">
                                      <img src="{{asset('website/image/catalog/demo/product/electronic/19-226x226.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium" class="img-responsive">
                                      </a>
                                    </div>
                                  </div>
                                  <div class="box-label">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_kjmz block">
                  <div class="banner-21 banner">
                    <div>
                      ...
                      <img src="{{asset('website/image/catalog/demo/banners/home6/banner21.jpg')}}" alt="Static Image">
                      </a>
                    </div>
                  </div>
                </div>
                                   ...
                                   <div class="item-sub-cat">
                                      <ul class="ltabs-tabs cf">
                                         <li class="ltabs-tab tab-sel" data-category-id="30" data-active-content=".items-category-30"><div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/116.jpg')}}"
                                              title="Bags" alt="Bags"
                                         ...
                                         <li class="ltabs-tab" data-category-id="31" data-active-content=".items-category-31"><div class="ltabs-tab-img">
                                            <img src="{{ asset('website/image/catalog/demo/category/23.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="32" data-active-content=".items-category-32">
                                           <div class="ltabs-tab-img">
                                              <img src="{{asset('website/image/catalog/demo/category/24.jpg')}}"
                                                title="Jean" alt="Jean"
                                                style="background:#fff"/>
                                            </div>
                                            <span class="ltabs-tab-label">
                                         ...
                                         <li class="ltabs-tab " data-category-id="33" data-active-content=".items-category-33">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/9.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="34" data-active-content=".items-category-34">
                                          <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/22.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="35" data-active-content=".items-category-35">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/25.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="36" data-active-content=".items-category-36">
                                            <div class="ltabs-tab-img">
                                              <img src="{{asset('website/image/catalog/demo/category/21.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="37" data-active-content=".items-category-37">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/10.jpg')}}"
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/24-226x226.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/16-226x226.png')}}" alt="Invisible Hidden Spy Earphone Micro Wireless">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/14-226x226.png')}}" alt="Ligula tortoram ut labore et dolore magna elip">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Ligula tortoram ut labore et dolore magna elip">
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/11-226x226.png')}}" alt="Ligula tortoram ut labore et dolore magna elip">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/18-226x226.png')}}" alt="magna elip therefore always free from bolac sodo">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Est Officia Including Shoes Beautiful Pieces Canaz">
                                          <img src="{{asset('website/image/catalog/demo/product/fashion/15-226x226.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-82%</span>
                                   ...
                                   <div class="item-sub-cat">
                                      <ul class="ltabs-tabs cf">
                                         <li class="ltabs-tab tab-sel" data-category-id="40" data-active-content=".items-category-40"><div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/94.jpg')}}"
                                              title="CASE" alt="CASE"
                                              style="background:#fff"/>
                                          </div>
                                          <span class="ltabs-tab-label">
                                         ...
                                         <li class="ltabs-tab " data-category-id="41" data-active-content=".items-category-41"><div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/93.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="42" data-active-content=".items-category-42">
                                           <div class="ltabs-tab-img">
                                              <img src="{{asset('website/image/catalog/demo/category/88.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="43" data-active-content=".items-category-43">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/90.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="44" data-active-content=".items-category-44">
                                          <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/87.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="45" data-active-content=".items-category-45">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/91.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="46" data-active-content=".items-category-46">
                                            <div class="ltabs-tab-img">
                                              <img src="{{asset('website/image/catalog/demo/category/89.jpg')}}"
                                         ...
                                         <li class="ltabs-tab " data-category-id="47" data-active-content=".items-category-47">
                                           <div class="ltabs-tab-img">
                                            <img src="{{asset('website/image/catalog/demo/category/92.jpg')}}"
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Charger  Compact Portable with Premium">
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/11-270x270.jpg')}}" alt="Charger  Compact Portable with Premium">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/14-270x270.jpg')}}" alt="Compact Portable Charger (External Battery) T21">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/21-270x270.jpg')}}" alt="Compact Portable Charger (External Battery) T22">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/26-270x270.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Mammo Diablo except to obtain some advan from">
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/6-270x270.jpg')}}" alt="Mammo Diablo except to obtain some advan from">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Portable  Compact Charger (External Battery) t45">
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/4-270x270.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-40%</span>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/28-270x270.jpg')}}" alt="LG 29UC97-S 29&quot;(21:9) FHD  IPS LED 2560X1080 HDMI(2)">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                                      ...
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          <a class="lt-image"
                                            href="product.html" target="_self"
                                            title="Compact Portable Charger (Power Bank) with Premium">
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/19-270x270.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-70%</span>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/5-270x270.jpg')}}" alt="SamSung 23UC97-S 29&quot;(21:9) FHD  IPS LED 2560X1080 ">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/9-270x270.jpg')}}" alt="Luma Extrem ich toil and pain can pcure him">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                          <span class="label-product label-sale">-20%</span>
                                    ...
                                    <div class="product-item-container">
                                      <div class="left-block ">
                                        <div class="image product-image-container so-quickview ">
                                          ...
                                          <img src="{{asset('website/image/catalog/demo/product/electronic/17-270x270.jpg')}}" alt="Compact Portable Charger (External Battery) T23">
                                          </a>
                                        </div>
                                        <div class="box-label">
                                        </div>
                  ...
                  <div class="banner-layout-5 row clearfix">
                    <div class="banner-22 col-sm-4  banners">
                      <div>
                        ...
                        <img src="{{asset('website/image/catalog/demo/banners/home6/banner22.jpg')}}" alt="Static Image">
                        </a>
                      </div>
                    </div>
                    <div class="banner-23 col-sm-4 banners">
                      <div>
                        ...
                        <img src="{{asset('website/image/catalog/demo/banners/home6/banner23.jpg')}}" alt="Static Image">
                        </a>
                      </div>
                    </div>
                    <div class="banner-24 col-sm-4  banners">
                      <div>
                        <a class="bn-shadow" href="#" title="Banner 24">
                        <img src="{{asset('website/image/catalog/demo/banners/home6/banner24.jpg')}}" alt="Static Image">
                        </a>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/25-234x234.jpg')}}" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-82% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Compact Portable Charger (Power Bank) with Premium">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/19-234x234.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-70% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Portable  Compact Charger (External Battery) t45">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/4-234x234.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-40% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/1-234x234.jpg')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-20% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Charger  Compact Portable with Premium">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/11-234x234.jpg')}}" alt="Charger  Compact Portable with Premium">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-20% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Compact Portable Charger (External Battery)">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/13-234x234.jpg')}}" alt="Compact Portable Charger (External Battery)">
                                </a>
                              </div>
                              <div class="box-label">
                              </div>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Compact Portable Charger (External Battery) T22">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/21-234x234.jpg')}}" alt="Compact Portable Charger (External Battery) T22">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-20% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/26-234x234.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-20% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Mammo Diablo except to obtain some advan from">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/6-234x234.jpg')}}" alt="Mammo Diablo except to obtain some advan from">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-20% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/29-234x234.jpg')}}" alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                </a>
                              </div>
                              <div class="box-label">
                                <span class="label-product label-sale">-11% </span>
                            ...
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                <a class="lt-image"
                                  href="product.html" target="_self"
                                  title="Compact Portable Charger (External Battery) T21">
                                <img src="{{asset('website/image/catalog/demo/product/electronic/14-234x234.jpg')}}" alt="Compact Portable Charger (External Battery) T21">
                                </a>
                              </div>
                              <div class="box-label">
                              </div>
                          ...
                          <div class="product-item-container">
                            <div class="left-block ">
                              <div class="product-image-container so-quickview">
                                ...
                                <img src="{{asset('website/image/catalog/demo/product/electronic/20-234x234.jpg')}}" alt="True Wireless Stereo Bluetooth 4.2 Headphones">
                                </a>
                              </div>
                              <div class="box-label">
                              </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_g1nr  block">
              <div class="row">
                <div class="banner-25 col-sm-6 banners">
                  ...
                  <img src="{{asset('website/image/catalog/demo/banners/home6/banner25.jpg')}}" alt="Static Image">
                  </a>
                  </div>
                </div>
                <div class="banner-26 col-sm-6  banners">
                  ...
                  <img src="{{asset('website/image/catalog/demo/banners/home6/banner26.jpg')}}" alt="Static Image">
                  </a>
                  </div>
                </div>
              </div>
