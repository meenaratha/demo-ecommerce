                                      ...
                                      <div class="pull-left">
                                          <form action="#" method="post" enctype="multipart/form-data" id="form-language">
                                              <div class="btn-group">
                                                  ...
                                                  <img src="{{ asset('website/image/catalog/flags/gb.png') }}" alt="English" title="English">
                                                  <span class="hidden-xs hidden-sm hidden-md">English</span>&nbsp;<i class="fa fa-angle-down"></i>
                                                  </button>
                                                  <ul class="dropdown-menu">
                                                      <li>
                                                          <button class="btn-block language-select" type="button" name="ar-ar"><img src="{{ asset('website/image/catalog/flags/ar.png')}}" alt="Arabic" title="Arabic"> Arabic</button>
                                                      </li>
                                                      <li>
                                                          <button class="btn-block language-select" type="button" name="en-gb"><img src="{{ asset('website/image/catalog/flags/gb.png')}}" alt="English" title="English"> English</button>
                                                      </li>
                                                  </ul>
                                              </div>
        ...
        <div class="container">
            <div class="row">
                <div class="navbar-logo col-lg-3 col-md-12 col-xs-12">
                          <a href="index6.php"><img src="{{ asset('website/image/catalog/demo/logo/logo-home6.png')}}" title="Your Store - Layout 6" alt="Your Store - Layout 6"></a>
                      </div>
                    ...
                    <li class="content-item">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-center size-img-cart">
                              <a href="product.html"><img src="{{ asset('website/image/catalog/demo/product/travel/10-54x54.jpg')}}" alt="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" title="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" class="img-thumbnail"></a>
                            </td>
                      ...
                      <table class="table table-striped" style="margin-bottom:10px;">
                        <tbody>
                          <tr>
                            <td class="text-center size-img-cart">
                              <a href="product.html"><img src="{{ asset('website/image/catalog/demo/product/travel/2-54x54.jpg')}}" alt="Canada Travel One or Two European Facials at  Studio" title="Canada Travel One or Two European Facials at  Studio" class="img-thumbnail"></a>
                            </td>
                            ...
                            <div class="container">
                              <ul class="megamenu" data-transition="slide" data-animationtime="300">
                                <li class="item-vertical  style1">
                                  ...
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-6.png')}}" alt="">Hot Deal</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical  vertical-style2 with-sub-menu hover">
                                  ...
                                  <a class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-1.png')}}" alt="">Electronics</strong>
                                  </span>
                                          ...
                                          <div class="html item-1">
                                            <div class="row">
                                              ...
                                              <div class="img-banner col-lg-5 col-md-5 col-sm-4">
                                                <a href="#"><img src="{{ asset('website/image/catalog/demo/menu/img-static-megamenu-h.jpg')}}" alt="banner"></a>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                ...
                                <li class="item-vertical  vertical-style3 with-sub-menu hover">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-2.png')}}" alt="">Travel &amp; Vacation</strong>
                                  </span>
                                  <b class="fa fa-caret-right"></b>
                                  </a>
                                        ...
                                        <div class="col-sm-7">
                                          <div class="html ">
                                            <div class="row img-banner">
                                              <a href="#"><img src="{{ asset('website/image/catalog/demo/menu/ver-img-1.jpg')}}" alt="banner"></a>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <li class="item-vertical">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-3.png')}}" alt="">Book Stationery</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical   item-style3 with-sub-menu hover">
                                  ...
                                  <a class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-4.png')}}" alt="">Fashion</strong>
                                  </span>
                                  <b class="fa fa-caret-right"></b>
                                  </a>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-12">
                                          <div class="link banner-full">
                                            <img src="{{ asset('website/image/catalog/demo/menu/menu_bg2.jpg')}}" alt="" style="width: 100%;">
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <li class="item-vertical">
                                  ...
                                  <a class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-5.png')}}" alt="">Sport &amp; Entertaiment</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical  css-menu with-sub-menu hover">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-8.png')}}" alt="">Spa &amp; Massage</strong>
                                  </span>
                                  <b class="fa fa-caret-right"></b>
                                  </a>
                                ...
                                <li class="item-vertical">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-9.png')}}" alt="">Real House</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-6.png')}}" alt="">Mom &amp; Baby</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-7.png')}}" alt="">Food &amp; Restaurant</strong>
                                  </span>
                                  </a>
                                </li>
                                <li class="item-vertical">
                                  ...
                                  <a href="#" class="clearfix">
                                  <span>
                                  <strong><img src="{{ asset('website/image/catalog/demo/menu/icon/icon-9.png')}}" alt="">Jewelry &amp; Watches</strong>
                                  </span>
                          ...
                          <div class="container">
                            <ul class="megamenu" data-transition="slide" data-animationtime="500">
                                        ...
                                        <div class="html ">
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="index.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout1.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 1</p>
                                            </a>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="home2.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout2.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 2 </p>
                                            </a>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="home3.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout3.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 3 </p>
                                            </a>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="home4.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout4.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 4 </p>
                                            </a>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="home5.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout5.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 5 </p>
                                            </a>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
                                            <a href="home6.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
                                              <img src="{{ asset('website/image/catalog/demo/menu/feature/layout6.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
                                              <p>Home Page 6 </p>
                                            </a>
                                          </div>
                                        </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-3">
                                              <div class="column">
                                                ...
                                                <div>
                                                  <ul class="row-list">
                                                    <li><a href="product.html"> size - small</a></li>
                                                    <li><a href="product-v2.html"> size - medium</a></li>
                                                    <li><a href="product-v3.html"> size - big</a></li>
                                                  </ul>
                                                </div>
                                              </div>
                                            </div>
                                ...
                                <div class="sub-menu" style="width: 100%; right: 0px;">
                                  <div class="content">
                                    <div class="row">
                                      <div class="col-sm-3">
                                        <div class="link ">
                                          <img src="{{ asset('website/image/catalog/demo/menu/menu-img1.jpg')}}" alt="" style="width: 100%;">
                                        </div>
                                      </div>
                                      <div class="col-sm-3">
                                        <div class="link ">
                                          <img src="{{ asset('website/image/catalog/demo/menu/menu-img2.jpg')}}" alt="" style="width: 100%;">
                                        </div>
                                      </div>
                                      <div class="col-sm-3">
                                        <div class="link ">
                                          <img src="{{ asset('website/image/catalog/demo/menu/menu-img3.jpg')}}" alt="" style="width: 100%;">
                                        </div>
                                      </div>
                                      <div class="col-sm-3">
                                        <div class="link ">
                                          <img src="{{ asset('website/image/catalog/demo/menu/menu-img4.jpg')}}" alt="" style="width: 100%;">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="border"></div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-4">
                                        <div class="product best-sellers-menu">
                                          <div class="">
                                            <a href="#" onclick="window.location = '#'"><img src="{{ asset('website/image/catalog/demo/product/fashion/24.png')}}" alt=""></a>
                                          </div>
                              ...
                              <li class="deal-h5 hidden">
                                ...
                                <a href="#" class="clearfix">
                                <strong>
                                <img src="{{ asset('website/image/catalog/demo/menu/hot-block.png')}}" alt="">Buy This Theme!
                                </strong>
                                </a>
                              </li>
                              <li class="deal-h5 hidden">
